...
class XJImporter:#专治各种不服
    ...
    def Import(self,module,args=None):
        ...
        # sys.path.append(os.path.join(absolutePath,'../Package_B'))
        # sys.path.append(os.path.join(absolutePath,'..'))
        # sys.path.append('C:\\Users\\Administrator\\Desktop\\ImportTest\\dist\\Main\\Package_B')
        
        print(path,sys.path)
        exec('import Package_B.trigger')
        # import trigger2
        context={}
        if(args):
            if(type(args)==str):
